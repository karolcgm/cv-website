          ...
          <header className="header">
            ...
            >
              <a href="mailto:piotr.peszkoo@gmail.com" className="contact-item">
                ...
                <span className="truncate">piotr.peszkoo@gmail.com</span>
              </a>
              ...
              <div className="contact-item">
                ...
                <span className="truncate">+48 535272451</span>
              </div>
              ...
              <div className="contact-item">
                ...
                <span className="truncate">Kukułcza 26, 43-190 Mikołów, Poland</span>
              </div>
            </motion.div>
          </header>
